...
@implementation DPCollectionFrame
...
- (void)setCollection:(DPCollection *)collection {
    ...
    // 时间的x是昵称的x
    CGFloat timeX = nameX;
    CGSize timeSize = [self sizeWithText:collection.created_at font:[UIFont systemFontOfSize:12]];
