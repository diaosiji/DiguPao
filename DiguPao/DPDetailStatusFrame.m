...
@implementation DPDetailStatusFrame
...
-(void)setStatus:(DPStatus *)status {
    ...
    /** Cell高度是最后算的 */
    // 不需要间隔 因为第二个section上面有留空
    self.cellHeight = CGRectGetMaxY(self.originalViewFrame); // 暂时
//    NSLog(@"DPDetailStatusFrame的setStatus调用成功");
